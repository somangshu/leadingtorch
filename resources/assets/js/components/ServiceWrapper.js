...
export default class ServiceWrapper extends Component {
	...
	render() {
		return (
			<div>
				<div className="position-relative contact-hero mb-5" style={{ backgroundImage: 'url("/images/services.jpg")', backgroundAttachment: "unset" }}>
					<div className="col-12 py-4 px-3 text-center my-5">
						<h2 className="font-weight-light text-left h1 px-5">Our Services</h2>
					</div>
